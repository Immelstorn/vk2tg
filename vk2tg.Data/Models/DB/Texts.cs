namespace vk2tg.Data.Models.DB
{
    public class Texts
    {
        ...
        public const string YouAreSubscribed = "Ты подписался на {0}. Как только появится новый пост, бот тебе его пришлет.";
        ...
        public const string NoSubscriptions = "Ты не подписан ни на одну группу.";
    }
}